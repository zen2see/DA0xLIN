...
// import { storagefactorydiamondaddress } from '../config/contractContext' 
// import  StorageFactoryFacet from '../../../hardhat/artifacts/contracts/SF/facets/StorageFactoryFacet.sol/StorageFactoryFacet.json'
...
export const useWeb3 = () => {
  ...
  //   </>
  // )
  return { web3Provider, disconnect, connect, address, chainData }
}
